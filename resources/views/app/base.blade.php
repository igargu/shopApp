					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form action="{{ $url ?? url('movie') }}">
		                            <input type="hidden" name="orderby" value="{{ $orderby ?? '' }}">
		                            <input type="hidden" name="ordertype" value="{{ $ordertype ?? '' }}">
		                            <input type="hidden" name="format" value="{{ $for ?? '' }}">
		                            <input type="hidden" name="genre" value="{{ $gen ?? '' }}">
		                            <input type="hidden" name="price" value="{{ $pri ?? '' }}">
									<input type="search" class="input" name="q" placeholder="Search here" value="{{ $q ?? '' }}">
